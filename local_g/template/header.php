<?php
$LOCAL_DOMAIN = 'http://localhost/sites/copy-congress';
            ...
            <transition name="fade">
                <div class="header__drop-menu" v-if="menuOpened">
                    ...
                    <div class="header__bottomline">
                        <p>Информационный центр конгресса</p>
                        <p><a href="tel:+74952210867">+7 (495) 221 0867</a></p>
                        <p><a href="mailto:congress_sputnik@roscongress.org">congress_sputnik@roscongress.org</a></p>
                    </div>
                </div>
            </transition>
        </div>
